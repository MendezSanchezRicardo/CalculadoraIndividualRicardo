package ipn.cecyt9.CalculadoraIndividual;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void NuevaArea() {
        Intent intent = new Intent(this,Areacubo.class);
    ...
    public void onClickMultiplicar(View miView){
        operador = "*";
        onClickOperacionCapturaNumero1(miView);
    }
    public void onClickDivirdir(View miView){
        operador = "/";
        onClickOperacionCapturaNumero1(miView);
    }
